                ...
                <article class={`card-content article${'direction' in page ? ' ' + page.direction : ''}`} role="article">
                    ...
                    {page.layout !== 'page' ? <div class="article-meta is-size-7 is-uppercase level is-mobile">
                        <div class="level-left">
                            ...
                            {/* Categories */}
                            {page.categories && page.categories.length ? <span class="level-item"><i class="fa-solid fa-folder-open"></i>&nbsp;
                                {(() => {
                                    const categories = [];
                            ...
                            {/* Read time */}
                            {article && article.readtime && article.readtime === true ? <span class="level-item"><i class="fa-regular fa-clock">&nbsp;</i>
                                {(() => {
                            ...
                            <>
                                ...
                                <i class="fa-regular fa-eye">&nbsp;</i> {/* 使用 Font Awesome 图标, 也可以换成其他图标 */}
                                </span>

                                {/* 渲染访问计数 */}
                                <span className="level-item" id="busuanzi_container_page_pv" dangerouslySetInnerHTML={{
                                __html: _p('plugin.visit_count', '<span id="busuanzi_value_page_pv">0</span>')
                                }}></span>
                            </>
                            ) : null}
